...
begin
  ...
  Memo1.Lines[i+1]:='радиус вписанной в него окружности '+EditR.Text;
  r:=strtofloat(EditR.Text);
  n:=strtofloat(EditN.Text);
  Memo1.Lines[i+2]:='тогда периметр этого многоугольника равен '+floattostr(round((2*r*n*tan(pi/n))*100)/100);
  i:=i+3;
end;
